...
import { ChevronDownIcon,EnvelopeIcon, ArrowTopRightOnSquareIcon } from '@heroicons/react/20/solid'
...
const People = ()=> {
    ...
    const [imageUrl, setImageUrl] = useState("https://t3.ftcdn.net/jpg/05/16/27/58/360_F_516275801_f3Fsp17x6HQK0xQgDQEELoTuERO4SsWV.jpg")
            ...
            <header className="absolute border-b border-gray-300 inset-x-0 top-0 z-50 ">
                <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                    ...
                    <div className="hidden lg:flex lg:gap-x-12">
                        ...
                        <button
                            className="sm:text-xl font-semibold text-indigo-500 transition-transform duration-300 hover:scale-110  cursor-pointer  ">
                            People
                        </button>
                        <button
                                    ...
                                    <Menu as="div" className="relative inline-block text-left">
                                        <div>
                                            <MenuButton
                                                ...
                                                <span className="relative inline-block">
                                                    <img alt="" src={imageUrl} className="size-6 rounded-full"/>
                                                </span>
                                                <h1 className="font-bold text-indigo-500">{loginUser && loginUser.name}</h1>
                                                <ChevronDownIcon aria-hidden="true" className="-mr-1 size-5 text-gray-400"/>
                                            </MenuButton>
