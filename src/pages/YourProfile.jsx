                                    ...
                                    <li key={project._id}
                                        ...
                                        <div className="flex flex-none items-center gap-x-4">
                                            <button disabled={notActive}
                                                ...
                                                className="rounded-md bg-white cursor-pointer px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-red-500 sm:block"
                                            >
                                                Withdraw
                                            </button>
