...
const ProfileDetails = ()=> {
    ...
    const getUserDetails = async () => {
        try{
            const usersDetails = await axios.post('/profile/get-profile', {ProfileId:id},{withCredentials: true});
            setUserDetails(usersDetails.data.data)
                    ...
                    <DialogPanel
                        ...
                        <div className="mt-6 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                ...
                                <div className="space-y-2 py-6">
                                    <button
                                        className="sm:text-xl font-semibold text-indigo-500 transition-transform duration-300 hover:scale-110 cursor-pointer hover:text-indigo-500"
                                        onClick={PeopleHandler}>
                                        People
                                    </button>
                                </div>
                        ...
                        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                            <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                                    ...
                                    <li key={userDetails?.email}
                                        ...
                                        <div>
                                            <div className="-mt-px flex divide-x divide-gray-200">
                                                <div className="flex w-0 hover:bg-neutral-50 flex-1">
                                                    <a
                                                ...
                                                <div className="-ml-px flex w-0 hover:bg-neutral-50 flex-1">
                                                    <a
                                ...
                                <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0 ">
                                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">{userDetails?.name}</h1>

                                    <div className="mt-1">
                                        <p className="text-xl tracking-tight text-gray-900">{userDetails?.title}</p>
                                    </div>
                                    <div className="mt-2 flex gap-2"><BuildingOffice2Icon className="h-6 w-5"/>- <h1
                                        className="font-bold">{userDetails.organization}</h1></div>
                                    <div className="flex mt-3">
                                        <MapPinIcon className="h-6 w-5"/><p
                                        className="font-bold">- {userDetails.location}</p>
                                    </div>
                                    ...
                                    <div className="mt-7">
                                        ...
                                        <div className="space-y-6 text-base text-gray-700">
                                            <h1 className="">{userDetails?.description}</h1>
                                        </div>
                                    </div>
