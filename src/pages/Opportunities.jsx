...
import { ChevronDownIcon,EnvelopeIcon, PhoneIcon ,ArrowTopRightOnSquareIcon} from '@heroicons/react/20/solid'
...
const Opportunities = ()=> {
    ...
    const getAllOpportunities = async () => {
        try{
            const allopportunities = await axios.get('/opportunity/get-all-opportunities', {withCredentials: true});
                ...
                <div className="relative pt-14">
                    ...
                    <div className="py-24 sm:py-15">
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <h1 className="text-5xl text-center mb-10  font-serif  text-gray-900 sm:text-6xl">
                                Available Opportunities
                            </h1>
                            {dataRecieved && <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                {allOpportunities.map((opportunity) => (
                                    <li key={opportunity._id}
                                        className="col-span-1 divide-y transition-transform duration-300 hover:scale-101 divide-gray-200 rounded-lg bg-white shadow-sm">
                                        <div className="flex w-full items-center justify-between space-x-6 p-6">
                                            <div className="flex-1 truncate">
                                                ...
                                                <h3 className="font-medium mt-1"> Required Skills</h3>
                                            ...
                                            <Link to={`/profiledetails/${opportunity.authorId}`}>
                                            <div className="flex-row justify-items-center justify-around transition-transform duration-300 hover:scale-105 cursor-pointer ">
                                                <img alt="" src={opportunity.imageUrl}
                                        ...
                                        <div>
                                            <div className="-mt-px flex divide-x divide-gray-200">
                                                ...
                                                <div className="-ml-px flex w-0 hover:bg-gray-50 flex-1">
                                                    <a
                                                        href={`mailto:${opportunity.authorEmail}`}
                                                        className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900"
                                                    >
                                                        CHAT <ChatBubbleBottomCenterIcon aria-hidden="true" className="size-4 text-gray-400"/>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            {!dataRecieved &&
                                <div role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                    <div
                                        className="col-span-1 divide-y h-60 transition-transform duration-300 hover:scale-101 divide-gray-200 rounded-lg bg-white shadow-sm">
                                        <div className="flex w-full mt-5 items-center justify-between space-x-6 p-6">
                                            <div className="flex-1 truncate">
                                                <div className="flex items-center space-x-3">
                                                    <Skeleton variant="text" width={210}
                                                              sx={{fontSize: '1rem'}}/>
                                                </div>
                                                <p className="mt-1 truncate text-sm text-gray-500"><Skeleton
                                                    variant="text"
                                                    width={210}
                                                    sx={{fontSize: '1rem'}}/>
                                                </p>
                                                <h3 className="font-medium mt-1"><Skeleton variant="text" width={210}
                                                                                           sx={{fontSize: '1rem'}}/>
                                                </h3>
                                                <h3 className="font-medium mt-1"><Skeleton variant="text" width={210}
                                                                                           sx={{fontSize: '1rem'}}/>
                                            ...
                                            <div
                                                className="flex-row justify-items-center justify-around transition-transform duration-300 hover:scale-105 cursor-pointer ">
                                        ...
                                        <div>
                                            <div className="-mt-px flex pt-2 divide-x divide-gray-200">
                                                <div className="flex w-0 flex-1 hover:bg-neutral-50">
                                                    <div
                                                ...
                                                <div className="-ml-px flex w-0 hover:bg-gray-50 flex-1">
                                                    <div
                                                        className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900"
                                                    >
                                                        CHAT <ChatBubbleBottomCenterIcon aria-hidden="true"
